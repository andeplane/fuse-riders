...
function world(tick: number, round: number, riders: Rider[], phase: ViewSnapshot['phase'] = 'playing'): ViewSnapshot {
  return {
    ...
    players: riders.map((rider, index) => ({
      ...
      targetBombArmed: false, tripleShotArmed: false, fiveShotArmed: false, nitroUntilTicks: [], snailUntilTicks: [], grip: false, shielded: false, shieldGraceUntilTick: 0, portalCooldownUntilTick: 0, portalGraceUntilTick: 0,
    })),
    map: 'classic', obstacles: [], bombs: [], blasts: [], pickups: [], portalPairs: [], gravityFields: [], leaderboard: [], roundPlacements: [], matchStats: [], moments: [],
  };
}
