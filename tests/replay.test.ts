...
function world(tick: number, round: number, riders: Rider[], phase: ViewSnapshot['phase'] = 'playing'): ViewSnapshot {
  return {
    ...
    players: riders.map((rider, index) => ({
      ...
      x: rider.x, y: rider.y ?? 450, angle: 0, alive: true, roundWins: 0, bombReadyAtTick: 0, trail: [], powerPickups: 0, reloadDurationTicks: 80, invulnerableUntilTick: 0, drunkUntilTick: 0, inkUntilTick: 0,
