...
test('controller snapshots strip the full match statistics table', () => {
  const matchStats: MatchPlayerStats = {
    ...
    powerPickups: 2, starPickups: 1, beerPickups: 0, inkPickups: 0, triplePickups: 0, fivePickups: 0, targetPickups: 0,
  ...
  const compact = controllerSnapshot({
    ...
    players: [], map: 'classic', obstacles: [], bombs: [], blasts: [], pickups: [], portalPairs: [], gravityFields: [], leaderboard: [], roundPlacements: [], matchStats: [matchStats],
