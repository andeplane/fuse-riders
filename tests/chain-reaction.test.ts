...
function twoBombs(chainReaction: boolean): GameState {
  ...
  state.bombs.set(2, { ...common, id: 2, ownerId: 'p1', x: 560, y: 450, explodeAtTick: state.tick + 500, flightPath: flightPath(560, 450) });
  return state;
}
