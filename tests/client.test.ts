...
function snapshot(): GameSnapshot {
  return { phase: 'lobby', matchLength: 5, aimBounce: false, bombChargeTicks: 8, width: 1600, height: 900, boundaryInset: 20, players: [], map: 'classic', obstacles: [], bombs: [], blasts: [], pickups: [], portalPairs: [], gravityFields: [], leaderboard: [], roundPlacements: [], matchStats: [], moments: [] };
}
...
function playingFrame(tick: number, receivedAt: number, x: number, alive = true): SnapshotFrame {
  return {
    ...
    snapshot: {
      ...
      players: [{ id: 'p1', name: 'One', avatarId: 'robot', slot: 0, color: '#00d9ff', connected: true, x, y: 100, angle: 0, alive, roundWins: 0, matchScoreUnits: 0, roundScoreUnits: 0, bombReadyAtTick: 0, trail: [], extraBombs: 0, fuseLevel: 0, powerPickups: 0, reloadDurationTicks: 80, invulnerableUntilTick: 0, boostUntilTick: 0, nitroUntilTicks: [], snailUntilTicks: [], grip: false, drunkUntilTick: 0, inkUntilTick: 0, tripleShotArmed: false, fiveShotArmed: false, targetBombArmed: false, gravityArmed: false,  shielded: false, shieldGraceUntilTick: 0, portalCooldownUntilTick: 0, portalGraceUntilTick: 0 }],
    },
  };
}
