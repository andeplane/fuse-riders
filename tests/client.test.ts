...
function snapshot(): GameSnapshot {
  return { phase: 'lobby', matchLength: 5, aimBounce: false, bombChargeTicks: 8, width: 1600, height: 900, boundaryInset: 20, players: [], bombs: [], blasts: [], pickups: [], portalPairs: [], gravityFields: [], leaderboard: [], roundPlacements: [], matchStats: [], moments: [] };
}
