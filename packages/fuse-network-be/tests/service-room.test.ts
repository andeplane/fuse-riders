...
import { RoomStore, RoomError, peerId, parseRoomRecord, type RoomDatabase, type RoomRecord, type RoomStoreDependencies } from '../src/room-store.js';
import { RoomGateway, type GatewaySocket } from '../src/gateway.js';
import { parseRoutedMessage, type RoomBus, type RoutedMessage } from '../src/room-bus.js';
