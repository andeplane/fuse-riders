...
import { createRace, step, type RaceEvent, type RaceState } from '../src/game/sim/race.js';
import { parseTrack } from '../src/game/sim/track.js';
import { botInput, createBotMemory, type BotMemory, type Difficulty } from '../src/game/sim/bot.js';
