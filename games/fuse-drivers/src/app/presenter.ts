...
import {
  CAPACITY,
  TICKS_PER_SECOND,
  type FuseDriversPlayerView,
  type FuseDriversView,
} from "../game/index.js";

/**
 * What the fuseDrivers screen shows, as a pure function of the view and who this device is. The screen renders from the
...
function row(view: FuseDriversView, player: FuseDriversPlayerView, me: string): PlayerRow {
...
function lobby(view: FuseDriversView, viewer: Viewer): LobbyModel {
...
export function presentTable(view: FuseDriversView, viewer: Viewer): TableModel {
