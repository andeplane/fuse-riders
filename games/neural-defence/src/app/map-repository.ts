...
const catalog: MapSummary[] = [
  { id: 'sandbox-12', title: 'Slate Basin', description: 'An open 12 × 12 field for growing your network.', width: 12, height: 12, url: sandboxUrl },
  { id: 'combat-lab-12', title: 'The Conduit', description: 'A contained assay for supply, pressure and a branch cut.', width: 12, height: 12, url: labUrl },
];

export function createBrowserMapRepository(fetcher: typeof fetch): MapRepository {
  return {
    async list(signal) {
