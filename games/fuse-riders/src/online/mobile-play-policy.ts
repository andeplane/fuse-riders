 ...
 *  An ended room is neither (`endedScreen` in room-screen.ts lets go of the phone layout), so the header status and BACK TO LOBBY are readable without ☰ MENU (#44).
