...
**ROOM SETTINGS → Bomb aim time (seconds)** adjusts how quickly a held bomb reaches maximum distance in solo and online rooms: 0.1–2 seconds in 0.05-second steps, default 0.4 seconds. Try 1.2 seconds for the original pace. Save to apply it next round; the room shares one active aim time for players, AI and previews. With aim bounce on, the aiming marker moves at a steady speed through the middle 75% of its range, smoothly slowing into each end and accelerating away without pausing. The range and time to maximum stay the same.
