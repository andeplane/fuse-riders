...
**Ball Bros POC** is also available at `/ball-bros/`, linked from the home page: solo against four bots or online rooms for up to five players, with orbital/radial paddles, destructible bases, power-ups and one-hit cores. Shared-screen rooms offer a TV view and phone controllers. At 01:00 remaining, Fuse Frenzy moves the base formation and adds neutral pressure balls. See [its controls and verification](games/ball-bros/README.md). It is unranked; new maps remain later work. Production rooms remain gated by `EXTRA_GAME_IDS=ball-bros`.
