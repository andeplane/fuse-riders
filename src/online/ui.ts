...
export async function startOnline():Promise<void>{
  ...
  });if(runtime instanceof RoomRuntime)void runtime.transport.diagnostics().then(report=>{app.dataset.linkDiagnostics=formatLinkDiagnostics(report.links,report.ice,report.socket);});},1000);
