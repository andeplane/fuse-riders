import { bombFuseTicks, GRAVITY_FIELD_TICKS, GRAVITY_MAX_HOLES_PER_PICKUP, INK_DURATION_TICKS, NITRO_DURATION_TICKS, NITRO_SPEED, SNAIL_DURATION_TICKS, SNAIL_SPEED, STAR_DURATION_TICKS, TICK_HZ, type PickupType } from '../shared/game.js';
...
const copy: Record<PickupType, readonly [name: string, description: string]> = {
  ...
  shell: ['SHELL', 'next shot bounces off walls and trails, and through portal gates, until it hits a rider, you included'],
  gun: ['GUN', 'tap to fire instantly ahead, through any portal gate; stops at the first body, cuts a small hole, and kills near its head'],
