...
export interface GameSnapshot {
  ...
  players: ReadonlyArray<{
    ...
    extraBombs: number; powerPickups: number; reloadDurationTicks: number; invulnerableUntilTick: number; boostUntilTick: number; drunkUntilTick: number; inkUntilTick: number;
