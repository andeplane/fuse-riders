...
export interface GameSnapshot {
  ...
  players: ReadonlyArray<{
    ...
    extraBombs: number; fuseLevel: number; powerPickups: number; reloadDurationTicks: number; invulnerableUntilTick: number; boostUntilTick: number; drunkUntilTick: number; inkUntilTick: number;
