...
export const OBSTACLE_KINDS = ["rock", "building", "crate", "pyramid"] as const;
...
/** IDs survive removals and rollback; neither array position nor the map's skin selects geometry. */
