...
export const RULES = "fuse-p2p-29"; // 29: the final round pauses for its own result, then MATCH_WINNER_TICKS more to name the match winner. 28: drunk riders stagger in uneven waves and drift (ADR-046). 27: the wrap and cross arena maps — open edges carry riders, shells, bullets, bombs and blasts through. 26: arena maps. 25: history agreement metadata.
