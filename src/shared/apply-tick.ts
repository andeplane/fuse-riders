...
export const RULES = 'fuse-p2p-26'; // 26: the wrap and cross arena maps — open edges carry riders, shells, bullets, bombs and blasts through. 25: arena maps. 24: Boost removed; Gravity opens black holes.
