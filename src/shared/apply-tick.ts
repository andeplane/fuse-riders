...
export const RULES = "fuse-p2p-28"; // 28: frozen round rating standings enter the canonical state. 27: the wrap and cross arena maps — open edges carry riders, shells, bullets, bombs and blasts through. 26: arena maps. 25: history agreement metadata.
