...
try{
 ...
 app.game.bombs=new Map(fixture.bombs.filter((_,i)=>i%3===0||i<4).map(b=>[b.id,{...b,flightPath:[...b.flightPath],placedTick:b.launchedTick}]));
 ...
 console.log('Captured actual LAN application with deterministic showcase state: docs/gameplay-phaser.png');
