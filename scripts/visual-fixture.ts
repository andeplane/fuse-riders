...
try {
  ...
  for (const [id,x,y] of [[1,405,145],[2,1040,355],[3,670,605]]) app.game.bombs.set(id,{id,ownerId:`p${id}`,launchX:x,launchY:y,x,y,placedTick:940,launchedTick:940,landsAtTick:946,explodeAtTick:980+id*5,blastRange:150});
