...
try {
  ...
  console.log(`Measuring a three-round match: five scripted player origins, six simulators, mixed Chromium/WebKit, real local WebRTC; ${profile} profile, seed ${seed}.`);
