...
# Steps: typecheck coverage build lan avatar keyboard online preview phaser home landscape recap shared deltas
set -euo pipefail
cd "$(dirname "$0")/.."
PORT="${PORT:-8787}"
...
for s in keyboard online home landscape recap shared; do needs "$s" && { start_room_service; break; }; done
