...
type BuildKind = "neuron" | "tower" | "siege" | "relay";
type StructureKind = "brain" | BuildKind;
type ParticleKind = "pulse" | "heavy" | "swift";
type Research =
