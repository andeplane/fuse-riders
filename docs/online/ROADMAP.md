...
Public product checks, the 30-minute source-66f67bd soak, mobile-sized Phaser benchmarks and subsequent regional/poor profiles are complete within their recorded scopes. See [current release status](PUBLIC-BETA-2026-09-14.md) and [completion audit](../reviews/online-completion-audit.md). Actual local response passes its proposed target; TV response tuning remains open. Poor-profile correction tails are measured and remain a limitation. The checklist below is the release procedure, not a claim that every item has never been run.
