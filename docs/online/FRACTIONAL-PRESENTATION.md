...
[`ViewPlayer.presentationTick`](../../src/engine/view.ts) is optional presentation metadata created locally after receiving a snapshot; it is absent from the wire protocol and authoritative game state. Its current consumer is the charge marker:
