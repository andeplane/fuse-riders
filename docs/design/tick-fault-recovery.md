...
| Time a faulted replica stays undecided         | until its inputs complete (the stall rule's business), then `FAULT_EVIDENCE_MS`                                                                                  |
