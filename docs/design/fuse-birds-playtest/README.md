...
[Solo practice](solo-practice.png) shows the one-player mode after Pebble and Scatter shots. The same UI starts without a room/opponent and offers **NEW MAP** to reset terrain and ammunition.
