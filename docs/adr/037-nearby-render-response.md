...
Status: implemented and independently reviewed. The measured candidate was accepted on 2026-09-14 after the fixed response batch; final CI and public release checks remain required.
