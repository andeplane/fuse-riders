...
Status: Removed in fold rules `fuse-p2p-40`. Target Bomb, the `aim` input, the AIM log entry (kind 1), `targetBombArmed` and `bombTarget` no longer exist; see [PROTOCOL.md](../online/PROTOCOL.md). Kept as a record of the design.
