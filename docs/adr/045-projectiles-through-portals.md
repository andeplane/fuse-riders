...
Lobbed bombs are excluded. They resolve against a landing point committed at launch rather than travelling, so a gate along the way is not something they can meet; changing that would move a landing point that the aim preview, the bots and portal placement reservation all read.
