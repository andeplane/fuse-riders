...
The stagger turns the heading faster than a rider can steer, on purpose: that is what makes the wave jagged. It cannot accumulate, so the debuff costs precision near trails and walls rather than control of where the rider is going.
